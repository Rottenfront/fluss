...
use crate::{Ellipse, Insets, PathEl, Point, RRect, RectRadii, Shape, Size, Vec2};
...
impl Rect {
    ...
    #[inline]
    pub fn translate(self, delta: impl Into<Vec2>) -> Rect {
    ...
    /// corner radius.
    #[inline]
    pub fn to_rounded_rect(self, radii: impl Into<RectRadii>) -> RRect {
        RRect::from_rect(self, radii)
    }
