// Copyright 2018 the GCL Authors
// SPDX-License-Identifier: Apache-2.0 OR MIT

//! 2D geometry, with a focus on curves.
//!
//! The gcl library contains data structures and algorithms for curves and
...
//! ```
//! use gcl::{Insets, Point, Rect, Size, Vec2};
//!
...
//!
//! ```
//! use gcl::{Circle, ParamCurve, ParamCurveNearest, Point, Shape};
//!
