// Copyright 2019 the GCL Authors
...
use crate::{Affine, CubicBez, Line, Point, QuadBez, Rect, Vec2};
...
pub struct TranslateScale {
    ...
    pub scale_x: f64,
    /// The scale component of this transformation on y-axis
    pub scale_y: f64,
}
...
impl TranslateScale {
    ...
    #[inline]
    pub const fn new(translation: Vec2, scale_x: f64, scale_y: f64) -> TranslateScale {
        TranslateScale {
            translation,
            scale_x,
            scale_y,
    ...
    #[inline]
    pub const fn scale(s_x: f64, s_y: f64) -> TranslateScale {
        TranslateScale::new(Vec2::ZERO, s_x, s_y)
    }

    /// Create a new transformation with scale only.
    #[inline]
    pub const fn single_scale(s: f64) -> TranslateScale {
        TranslateScale::new(Vec2::ZERO, s, s)
    }

    /// Create a new transformation with translation only.
    #[inline]
    pub fn translate(translation: impl Into<Vec2>) -> TranslateScale {
        TranslateScale::new(translation.into(), 1.0, 1.0)
    }
    ...
    /// ```
    #[inline]
    pub fn from_scale_about(s_x: f64, s_y: f64, focus: Point) -> Self {
        ...
        let translation = focus - (focus.x * s_x, focus.y * s_y).into();
        Self::new(translation, s_x, s_y)
    }
    ...
    pub fn inverse(self) -> TranslateScale {
        let scale_recip_x = self.scale_x.recip();
        let scale_recip_y = self.scale_y.recip();
        TranslateScale {
            translation: Vec2::new(
                self.translation.x * -scale_recip_x,
                self.translation.y * -scale_recip_y,
            ),
            scale_x: scale_recip_x,
            scale_y: scale_recip_y,
        }
    }
    ...
    pub fn is_finite(&self) -> bool {
        self.translation.is_finite() && self.scale_x.is_finite() && self.scale_y.is_finite()
    }

    /// Is this translate/scale NaN?
    #[inline]
    pub fn is_nan(&self) -> bool {
        self.translation.is_nan() || self.scale_x.is_nan() || self.scale_y.is_nan()
    }
}
...
impl Default for TranslateScale {
    ...
    fn default() -> TranslateScale {
        TranslateScale::new(Vec2::ZERO, 1.0, 1.0)
    }
}
...
impl From<TranslateScale> for Affine {
    fn from(ts: TranslateScale) -> Affine {
        ...
        Affine::new([scale_x, 0.0, 0.0, scale_y, translation.x, translation.y])
    }
}
...
impl Mul<Point> for TranslateScale {
    ...
    fn mul(self, other: Point) -> Point {
        Point::new(self.scale_x * other.x, self.scale_y * other.y) + self.translation
    }
}
...
impl Mul for TranslateScale {
    ...
    fn mul(self, other: TranslateScale) -> TranslateScale {
        TranslateScale {
            translation: Vec2::new(
                self.translation.x + self.scale_x * other.translation.x,
                self.translation.y + self.scale_y * other.translation.y,
            ),
...
impl Mul<TranslateScale> for f64 {
    ...
    fn mul(self, other: TranslateScale) -> TranslateScale {
        TranslateScale {
            ...
            scale_x: other.scale_x * self,
            scale_y: other.scale_y * self,
        }
    }
}
...
mod tests {
    ...
    fn translate_scale() {
        ...
        let ts = TranslateScale::new(Vec2::new(5.0, 6.0), 2.0, 2.0);
    ...
    fn conversions() {
        ...
        let ts = TranslateScale::new(t, s, s);
        ...
        assert_near(
            ...
            TranslateScale::single_scale(s) * p,
        );
