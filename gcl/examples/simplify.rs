// Copyright 2022 the GCL Authors
...
fn main() {
    ...
    let simpl = gcl::simplify::SimplifyBezPath::new(path);
    let simplified_path = gcl::fit_to_bezpath_opt(&simpl, 0.1);
    println!(
