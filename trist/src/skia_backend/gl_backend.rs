...
pub struct SkiaEnv {
    ...
    num_samples: usize,
    stencil_size: usize,
    drawer_state: SkiaDrawerState,
}

impl crate::TristBackend<SkiaDrawerState> for SkiaEnv {
    fn new<E>(winit_window_builder: WindowBuilder, event_loop: &EventLoop<E>) -> Self {
        ...
        Self {
            ...
            num_samples,
            stencil_size,
            drawer_state: SkiaDrawerState::new(),
        }
    }
    ...
    fn get_drawer_state(&mut self) -> &mut SkiaDrawerState {
