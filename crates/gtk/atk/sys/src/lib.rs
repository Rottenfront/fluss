...
// Aliases
pub type AtkAttributeSet = glib_sys::GSList;
...
pub struct AtkActionIface {
    pub parent: gobject_sys::GTypeInterface,
...
pub struct AtkEditableTextIface {
    pub parent_interface: gobject_sys::GTypeInterface,
...
pub struct AtkObjectFactoryClass {
    ...
    pub create_accessible:
        Option<unsafe extern "C" fn(*mut gobject_sys::GObject) -> *mut AtkObject>,
...
pub struct AtkPropertyValues {
    ...
    pub old_value: gobject_sys::GValue,
    pub new_value: gobject_sys::GValue,
}
...
pub struct AtkStreamableContentIface {
    ...
    pub get_stream: Option<
        unsafe extern "C" fn(*mut AtkStreamableContent, *const c_char) -> *mut glib_sys::GIOChannel,
    >,
    pub get_uri:
...
pub struct AtkTableCellIface {
    ...
    pub get_column_header_cells:
        Option<unsafe extern "C" fn(*mut AtkTableCell) -> *mut glib_sys::GPtrArray>,
    pub get_position:
...
pub struct AtkUtilClass {
    ...
    pub add_global_event_listener:
        Option<unsafe extern "C" fn(gobject_sys::GSignalEmissionHook, *const c_char) -> c_uint>,
...
pub struct AtkValueIface {
    pub parent: gobject_sys::GTypeInterface,
    pub get_current_value: Option<unsafe extern "C" fn(*mut AtkValue, *mut gobject_sys::GValue)>,
    pub get_maximum_value: Option<unsafe extern "C" fn(*mut AtkValue, *mut gobject_sys::GValue)>,
    pub get_minimum_value: Option<unsafe extern "C" fn(*mut AtkValue, *mut gobject_sys::GValue)>,
    pub set_current_value:
        Option<unsafe extern "C" fn(*mut AtkValue, *const gobject_sys::GValue) -> gboolean>,
    pub get_minimum_increment:
        Option<unsafe extern "C" fn(*mut AtkValue, *mut gobject_sys::GValue)>,
    ...
    pub get_sub_ranges: Option<unsafe extern "C" fn(*mut AtkValue) -> *mut glib_sys::GSList>,
...
pub struct AtkHyperlink {
    pub parent: gobject_sys::GObject,
}
...
pub struct AtkRegistry {
    pub parent: gobject_sys::GObject,
    pub factory_type_registry: *mut glib_sys::GHashTable,
    pub factory_singleton_cache: *mut glib_sys::GHashTable,
}
...
pub struct AtkRelation {
    pub parent: gobject_sys::GObject,
    pub target: *mut glib_sys::GPtrArray,
...
pub struct AtkRelationSet {
    pub parent: gobject_sys::GObject,
    pub relations: *mut glib_sys::GPtrArray,
}
...
extern "C" {
    ...
    pub fn atk_gobject_accessible_for_object(obj: *mut gobject_sys::GObject) -> *mut AtkObject;
    ...
    pub fn atk_no_op_object_new(obj: *mut gobject_sys::GObject) -> *mut AtkObject;
    ...
    pub fn atk_relation_get_target(relation: *mut AtkRelation) -> *mut glib_sys::GPtrArray;
    ...
    pub fn atk_table_cell_get_column_header_cells(
    ...
    pub fn atk_table_cell_get_row_header_cells(cell: *mut AtkTableCell)
        -> *mut glib_sys::GPtrArray;
    ...
    pub fn atk_value_get_current_value(obj: *mut AtkValue, value: *mut gobject_sys::GValue);
    pub fn atk_value_get_increment(obj: *mut AtkValue) -> c_double;
    pub fn atk_value_get_maximum_value(obj: *mut AtkValue, value: *mut gobject_sys::GValue);
    pub fn atk_value_get_minimum_increment(obj: *mut AtkValue, value: *mut gobject_sys::GValue);
    pub fn atk_value_get_minimum_value(obj: *mut AtkValue, value: *mut gobject_sys::GValue);
    pub fn atk_value_get_range(obj: *mut AtkValue) -> *mut AtkRange;
    pub fn atk_value_get_sub_ranges(obj: *mut AtkValue) -> *mut glib_sys::GSList;
    ...
    pub fn atk_add_global_event_listener(
        listener: gobject_sys::GSignalEmissionHook,
