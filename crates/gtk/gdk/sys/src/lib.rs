...
pub const GDK_EVENT_PROPAGATE: gboolean = glib_sys::GFALSE;
pub const GDK_EVENT_STOP: gboolean = glib_sys::GTRUE;
...
pub type GdkWindowInvalidateHandlerFunc =
    Option<unsafe extern "C" fn(*mut GdkWindow, *mut cairo_sys::cairo_region_t)>;
...
pub struct GdkEventExpose {
    ...
    pub region: *mut cairo_sys::cairo_region_t,
    pub count: c_int,
}
...
pub struct GdkWindowClass {
    ...
    pub create_surface: Option<
        unsafe extern "C" fn(*mut GdkWindow, c_int, c_int) -> *mut cairo_sys::cairo_surface_t,
    >,
...
extern "C" {
    ...
    pub fn gdk_gl_error_quark() -> glib_sys::GQuark;
    ...
    pub fn gdk_event_handler_set(
        func: GdkEventFunc,
        data: gpointer,
        notify: glib_sys::GDestroyNotify,
    );
    ...
    pub fn gdk_cursor_get_image(cursor: *mut GdkCursor) -> *mut gdk_pixbuf_sys::GdkPixbuf;
    ...
    pub fn gdk_device_list_axes(device: *mut GdkDevice) -> *mut glib_sys::GList;
    pub fn gdk_device_list_slave_devices(device: *mut GdkDevice) -> *mut glib_sys::GList;
    ...
    pub fn gdk_display_list_devices(display: *mut GdkDisplay) -> *mut glib_sys::GList;
    pub fn gdk_display_list_seats(display: *mut GdkDisplay) -> *mut glib_sys::GList;
    ...
    pub fn gdk_display_manager_list_displays(
        manager: *mut GdkDisplayManager,
    ) -> *mut glib_sys::GSList;
    ...
    pub fn gdk_drag_context_list_targets(context: *mut GdkDragContext) -> *mut glib_sys::GList;
    ...
    pub fn gdk_keymap_get_direction(keymap: *mut GdkKeymap) -> pango_sys::PangoDirection;
    ...
    pub fn gdk_screen_get_font_options(
        screen: *mut GdkScreen,
    ) -> *const cairo_sys::cairo_font_options_t;
    ...
    pub fn gdk_window_begin_draw_frame(
        window: *mut GdkWindow,
        region: *const cairo_sys::cairo_region_t,
    ...
    pub fn gdk_window_create_similar_image_surface(
        window: *mut GdkWindow,
        format: cairo_sys::cairo_format_t,
        width: c_int,
        height: c_int,
        scale: c_int,
    ) -> *mut cairo_sys::cairo_surface_t;
    pub fn gdk_window_create_similar_surface(
        window: *mut GdkWindow,
        content: cairo_sys::cairo_content_t,
        width: c_int,
        height: c_int,
    ) -> *mut cairo_sys::cairo_surface_t;
    ...
    pub fn gdk_window_get_background_pattern(
        window: *mut GdkWindow,
    ) -> *mut cairo_sys::cairo_pattern_t;
    pub fn gdk_window_get_children(window: *mut GdkWindow) -> *mut glib_sys::GList;
    pub fn gdk_window_get_children_with_user_data(
        window: *mut GdkWindow,
        user_data: gpointer,
    ) -> *mut glib_sys::GList;
    pub fn gdk_window_get_clip_region(window: *mut GdkWindow) -> *mut cairo_sys::cairo_region_t;
    ...
    pub fn gdk_window_get_update_area(window: *mut GdkWindow) -> *mut cairo_sys::cairo_region_t;
    pub fn gdk_window_get_user_data(window: *mut GdkWindow, data: *mut gpointer);
    pub fn gdk_window_get_visible_region(window: *mut GdkWindow) -> *mut cairo_sys::cairo_region_t;
    ...
    pub fn gdk_window_input_shape_combine_region(
        window: *mut GdkWindow,
        shape_region: *const cairo_sys::cairo_region_t,
        offset_x: c_int,
        offset_y: c_int,
    );
    ...
    pub fn gdk_window_mark_paint_from_clip(window: *mut GdkWindow, cr: *mut cairo_sys::cairo_t);
    ...
    pub fn gdk_window_peek_children(window: *mut GdkWindow) -> *mut glib_sys::GList;
    ...
    pub fn gdk_window_set_background_pattern(
        window: *mut GdkWindow,
        pattern: *mut cairo_sys::cairo_pattern_t,
    );
    ...
    pub fn gdk_window_set_icon_list(window: *mut GdkWindow, pixbufs: *mut glib_sys::GList);
    ...
    pub fn gdk_window_set_opaque_region(
        window: *mut GdkWindow,
    ...
    pub fn gdk_window_set_user_data(window: *mut GdkWindow, user_data: *mut gobject_sys::GObject);
    ...
    // Other functions
    //=========================================================================
    pub fn gdk_add_option_entries_libgtk_only(group: *mut glib_sys::GOptionGroup);
    pub fn gdk_beep();
    pub fn gdk_cairo_create(window: *mut GdkWindow) -> *mut cairo_sys::cairo_t;
    ...
    pub fn gdk_cairo_get_drawing_context(cr: *mut cairo_sys::cairo_t) -> *mut GdkDrawingContext;
    pub fn gdk_cairo_rectangle(cr: *mut cairo_sys::cairo_t, rectangle: *const GdkRectangle);
    pub fn gdk_cairo_region(cr: *mut cairo_sys::cairo_t, region: *const cairo_sys::cairo_region_t);
    pub fn gdk_cairo_region_create_from_surface(
        surface: *mut cairo_sys::cairo_surface_t,
    ) -> *mut cairo_sys::cairo_region_t;
    pub fn gdk_cairo_set_source_color(cr: *mut cairo_sys::cairo_t, color: *const GdkColor);
    pub fn gdk_cairo_set_source_pixbuf(
        cr: *mut cairo_sys::cairo_t,
        pixbuf: *const gdk_pixbuf_sys::GdkPixbuf,
        pixbuf_x: c_double,
        pixbuf_y: c_double,
    );
    pub fn gdk_cairo_set_source_rgba(cr: *mut cairo_sys::cairo_t, rgba: *const GdkRGBA);
    ...
    pub fn gdk_list_visuals() -> *mut glib_sys::GList;
    ...
    pub fn gdk_offscreen_window_get_surface(
        window: *mut GdkWindow,
    ) -> *mut cairo_sys::cairo_surface_t;
    pub fn gdk_offscreen_window_set_embedder(window: *mut GdkWindow, embedder: *mut GdkWindow);
    pub fn gdk_pango_context_get() -> *mut pango_sys::PangoContext;
    pub fn gdk_pango_context_get_for_display(
        display: *mut GdkDisplay,
    ...
    pub fn gdk_pango_layout_line_get_clip_region(
        line: *mut pango_sys::PangoLayoutLine,
        x_origin: c_int,
        y_origin: c_int,
        index_ranges: *const c_int,
        n_ranges: c_int,
    ...
    pub fn gdk_setting_get(name: *const c_char, value: *mut gobject_sys::GValue) -> gboolean;
    ...
    pub fn gdk_threads_add_idle(function: glib_sys::GSourceFunc, data: gpointer) -> c_uint;
    pub fn gdk_threads_add_idle_full(
        priority: c_int,
        function: glib_sys::GSourceFunc,
        data: gpointer,
        notify: glib_sys::GDestroyNotify,
    ) -> c_uint;
    ...
    pub fn gdk_threads_set_lock_functions(
        enter_fn: gobject_sys::GCallback,
        leave_fn: gobject_sys::GCallback,
    );
