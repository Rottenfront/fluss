...
extern "C" {
    ...
    pub fn gdk_x11_monitor_get_output(monitor: *mut gdk_sys::GdkMonitor) -> xlib::XID;
    ...
    // Other functions
    //=========================================================================
    pub fn gdk_x11_atom_to_xatom(atom: gdk_sys::GdkAtom) -> xlib::Atom;
    pub fn gdk_x11_atom_to_xatom_for_display(
        display: *mut GdkX11Display,
        atom: gdk_sys::GdkAtom,
    ) -> xlib::Atom;
    ...
    pub fn gdk_x11_get_parent_relative_pattern() -> *mut cairo_sys::cairo_pattern_t;
    ...
    pub fn gdk_x11_xatom_to_atom(xatom: xlib::Atom) -> gdk_sys::GdkAtom;
