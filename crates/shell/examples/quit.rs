...
use shell::kurbo::{Line, Size};
use shell::piet::{Color, RenderContext};

use shell::{Application, HotKey, Menu, Region, SysMods, WinHandler, WindowBuilder, WindowHandle};
...
fn main() {
    ...
    file_menu.add_item(
        0x100,
        "E&xit",
        Some(&HotKey::new(SysMods::Ctrl, "q")),
        None,
        true,
    );
