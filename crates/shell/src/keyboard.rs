...
/// That's important to note that we swap ctrl and meta modifiers on macOS to
/// make it easier to create cross-platform applications
impl Modifiers {
    ...
    pub fn ctrl(&self) -> bool {
        #[cfg(target_os = "macos")]
        return self.contains(Modifiers::META);
        #[cfg(not(target_os = "macos"))]
        return self.contains(Modifiers::CONTROL);
    }
