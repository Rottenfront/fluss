...
impl<A: 'static, F: Fn(&mut Context, Vec2, GestureState, Option<MouseButton>) -> A> DragFn
    for DragFunc<F>
{
    fn call(
        &self,
...
impl<A: 'static, F: Fn(&mut Context, Point, GestureState, Option<MouseButton>) -> A> DragFn
    for DragFuncP<F>
{
    fn call(
        &self,
...
impl<
        F: Fn(&mut T, Vec2, GestureState, Option<MouseButton>) -> A + 'static,
        B: Binding<T>,
        A: 'static,
        T: 'static,
